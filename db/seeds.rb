...
enrolled to study for the year-long Leith’s Diploma of Food and Wine.",
password: 'passss', avatar: 'lorraine-pascale.jpg', radius: '4')
...
with a degree in English, he spent a few years running a disco before buying a nightclub in Padstow.", avatar: 'rick-stein.jpg', radius: '11')
...
become known for her sensual descriptions of her dishes.", avatar: 'nigella-lawson.jpg', radius: '5')

User.create!(name: 'Zoe Tourle', location_lat: '54.321', location_lon: '-1', email: 'resident@hot.com', password: 'passss',
bio: "Zoe Tourle worked her way up from being a pub chef, to the head chef at the WGC mansion. Famed for her undercooked
 brownies and Key Lime pie, Zoe is the most popular person onsite.", avatar: 'zoe.jpg', radius: '2')

User.create!(name: 'Hairy Bikers', location_lat: '50.321', location_lon: '1.5', email: 'hairy@hot.com', password: 'passss', bio:
"The Hairy Bikers are David Myers and Simon King, two northern blokes with a passion for cooking and food. The pair began their TV
 ...
 BBC make-up artist specialising in prosthetics. It was on the set of a TV drama that they first met and became friends.", avatar: 'hairy-bikers.jpg', radius: '10')
...
a boyfriend kept praising his former girlfriend's talents in the kitchen that she got fed up and started cooking seriously.", avatar: 'delia-smith.jpg', radius: '15')
